<html>
    <h1>My second web based application : Image Generator by MidJourney</h1>
    <form action="/" method="post">
        <p>Please enter the image description : </p>
        <p><input type="text" name="q"></p>
        <p><input type="submit" value="Enter"></p>
    </form>
    <p>The link to image generated {{result}}</p>
    <p><img src={{result}}></p>
</html>
============================================
...
headers = {
    "Authorization" : "Token r8_6173dF40oPfp1jwNAJ0Fc8qh9K1v6Ev1s5yBx",
